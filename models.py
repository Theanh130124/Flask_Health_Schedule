...
#uselist=False -> chỉ có duy nhất  -> nếu 1 - n thì không cần
#lazy=true -> không load
#backref -> cho phép profile.user
...
class User(BaseModel):
    ...
    avatar = db.Column(db.String(255), default="https://res.cloudinary.com/dxiawzgnz/image/upload/v1732632586/pfvvxablnkaeqmmbqeit.png")
    is_active = db.Column(db.Boolean, default=True)

    patient = db.relationship('Patient', lazy=True  , backref='user', uselist=False) #có thể
